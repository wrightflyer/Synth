      ...
      switch(control) {
        ...
        case 75:
          ...
          for (i = 0; i < NUM_VOICES; i++) {
            phatBass.voice[i].setOsc1Amp(fTemp);
          }
          break;
        ...
        case 76:
          ...
          for (i = 0; i < NUM_VOICES; i++) {
            phatBass.voice[i].setOsc2Amp(fTemp);
          }
          break;
        ...
        case 77:
          ...
          for (i = 0; i < NUM_VOICES; i++) {
            phatBass.voice[i].setWaveAmp(fTemp);
          }
          break;
        ...
        case 102:
          ...
          for (i = 0; i < NUM_VOICES; i++) {
            phatBass.voice[i].setNoiseAmp(fTemp);
          }
          break;
        ...
        case 103:
          ...
          for (i = 0; i < NUM_VOICES; i++) {
            phatBass.voice[i].setADSRAttack(fTemp);
          }
          break;
        ...
        case 104:
          ...
          for (i = 0; i < NUM_VOICES; i++) {
            phatBass.voice[i].setADSRDecay(fTemp);
          }
          break;
        ...
        case 105:
          ...
          for (i = 0; i < NUM_VOICES; i++) {
            phatBass.voice[i].setADSRSustain(fTemp);
          }
          break;
        ...
        case 106:
          ...
          for (i = 0; i < NUM_VOICES; i++) {
            phatBass.voice[i].setADSRRelease(fTemp);
          }
          break;
        ...
        case 107:
          {
              ...
              phatBass.Filter.setFiltBand(band);
          }
          break;
        ...
        case 108:
          ...
          phatBass.Filter.setFiltFreq(fTemp);
          break;
    
        case 109:
          fTemp = mapf(value, 0, 127, 0.7, 5.0);
          Serial.printf("Resonance = %.2f\n", fTemp);
          phatBass.Filter.setFiltRes(fTemp);
          break;
        ...
        case 117:
          ...
          if (control == 110) {
            Serial.println("LFO1)");
            phatBass.LFOs.setLFO1Waveform(change);
          }
          if (control == 111) {
            Serial.println("LFO2)");
            phatBass.LFOs.setLFO2Waveform(change);
          }
          if (control == 116) {
            Serial.println("OSC1)");
            for (i = 0; i < NUM_VOICES; i++) {
                phatBass.voice[i].setOsc1Waveform(change);
            }
          }
          if (control == 117) {
            Serial.println("OSC2)");
            for (i = 0; i < NUM_VOICES; i++) {
                phatBass.voice[i].setOsc2Waveform(change);
            }
          }
          break;
        ...
        case 112:
          ...
          phatBass.LFOs.setLFO1Freq(fTemp);
          break;
    
        case 114:
          fTemp = mapf(value, 0, 127, 0.0, 0.2);
          Serial.printf("LFO1 depth = %.2f\n", fTemp);
          phatBass.LFOs.setLFO1Depth(ftemp);
          break;
    
        case 20:
          fTemp = mapf(value, 0, 127, 0.0, 1.0);
          Serial.printf("LFO1 PWM = %.2f\n", fTemp);
          phatBass.LFOs.setLFO1PWM(ftemp);
          break;
        ...
        case 113:
          ...
          phatBass.LFOs.setLFO2Freq(fTemp);
          break;
    
        case 115:
          fTemp = mapf(value, 0, 127, 0.0, 0.2);
          Serial.printf("LFO2 depth = %.2f\n", fTemp);
          phatBass.LFOs.setLFO2Depth(ftemp);
          break;
    
        case 21:
          fTemp = mapf(value, 0, 127, 0.0, 1.0);
          Serial.printf("LFO2 PWM = %.2f\n", fTemp);
          phatBass.LFOs.setLFO2PWM(ftemp);
          break;
        ...
        case 118:
            ...
            for (i = 0; i < NUM_VOICES; i++) {
                phatBass.voice[i].setOsc1Semis(fTemp);
            }
            break;
        ...
        case 23:
            ...
            n -= 24;
            for (i = 0; i < NUM_VOICES; i++) {
                phatBass.voice[i].setOsc1Octave(n);
            }
        ...
        case 25:
            ...
            for (i = 0; i < NUM_VOICES; i++) {
                phatBass.voice[i].setOsc1Detune(fTemp);
            }
            break;
        ...
        case 14:
          ...
          if (value < 64) {
            for (i = 0; i < NUM_VOICES; i++) {
                phatBass.voice[i].setOsc1Mod(Mod_FM);
            }
          }
          else {
            for (i = 0; i < NUM_VOICES; i++) {
                phatBass.voice[i].setOsc1Mod(Mod_PM);
            }
          }
          break;
        ...
        case 119:
            ...
            for (i = 0; i < NUM_VOICES; i++) {
                phatBass.voice[i].setOsc2Semis(fTemp);
            }
            break;
        ...
        case 26:
            ...
            n -= 24;
            for (i = 0; i < NUM_VOICES; i++) {
                phatBass.voice[i].setOsc2Octave(n);
            }
            Serial.printf("Osc1 Octave: %d\n", n);
          break;
        ...
        case 15:
          ...
          if (value < 64) {
            for (i = 0; i < NUM_VOICES; i++) {
                phatBass.voice[i].setOsc2Mod(Mod_FM);
            }
          }
          else {
            for (i = 0; i < NUM_VOICES; i++) {
                phatBass.voice[i].setOsc2Mod(Mod_PM);
            }
          }
          break;
        ...
        case 22:
          ...
          phatBass.Filter.setFiltAttack(fTemp);
          break;
    
        case 24:
          fTemp = mapf(value, 0, 127, 0.0, 3000.0);
          Serial.printf("Filter Decay = %.2f\n", fTemp);
          phatBass.Filter.setFiltDecay(fTemp);
          break;
    
        case 28:
          fTemp = mapf(value, 0, 127, 0.0, 1.0);
          Serial.printf("Filter Sustain = %.2f\n", fTemp);
          phatBass.Filter.setFiltSustain(fTemp);
          break;
    
        case 29:
          fTemp = mapf(value, 0, 127, 0.0, 3000.0);
          Serial.printf("Filter Release = %.2f\n", fTemp);
          phatBass.Filter.setFiltRelease(fTemp);
          break;
        ...
        case 30:
          ...
          Serial.printf("DC = %.2f\n", fTemp);
          phatBass.Filter.setFiltDC(fTemp);
          break;
        ...
        case 31:
          ...
          phatBass.Filter.setFiltModulation(n);
          if (n == 0) {
            dumpPatch();
          }
          break;
        ...
        case 85:
          value /= 20;
          value *= 20;
          Arp.setArpMode(value);
          break;
    
        case 86:
          Arp.setArpOctave(value / 20);
        ...
        case 91:
          ...
          phatBass.Filter.setChorusVoices(n);
          updateChorus();
          break;
